<template>
    <div class="w-full h-72 md:h-48 ms:h-auto bg-gray-100 rounded-t-2xl">
        <h1 class="relative text-4xl font-bold text-black top-8 left-8 md:top-10 md:left-32">为什么值得游玩？</h1>
        <div data-aos="fade-up" class="flex justify-center items-center h-full w-5/6 mx-auto ms:mt-4 md:mt-16">
            ...
            <div data-aos="fade-up" data-aos-delay="1000" class="flex-1 w-64 h-32 mb-16 ms:mt-24 mx-8">
                <div class="flex items-center">
                    <i class="icon icon-wanfa text-4xl p-1 bg-white rounded-md"></i>
                    <h1 class="text-2xl font-bold text-black ml-2">有趣的玩法</h1>
                </div>
                <p class="text-sm text-black mt-2">MistMC 不仅拥有粘液科技，还拥有从养老到建筑的各个方面内容。</p>
            </div>
