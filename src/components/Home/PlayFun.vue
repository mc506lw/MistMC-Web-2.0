<template>
    <div class="bg-white h-auto w-full">
        ...
        <div data-aos="fade-up" class="flex flex-col gap-6 md:flex-row md:gap-8 xl:gap-24 items-center mx-[10vw] mt-24">
            <div class="flex-1 rounded-xl relative">
                <img src="/img/sf2.png" class="shadow-2xl rounded-2xl object-cover">
            </div>
        ...
        <div class="block md:hidden">
            <div data-aos="fade-up"
                ...
                <div class="w-full flex-1 rounded-xl relative">
                    <img src="/img/yl2.png" class="shadow-2xl rounded-2xl object-cover">
                </div>
                <div class="w-full flex-1 flex flex-col justify-center">
        ...
        <div data-aos="fade-up" class="flex flex-col gap-6 md:flex-row md:gap-8 xl:gap-24 items-center mx-[10vw] my-16">
            <div class="w-full flex-1 rounded-xl aspect-video relative">
                <img src="/img/yl1.png" class="shadow-2xl rounded-2xl object-cover">
            </div>
            <div class="w-full flex-1 flex flex-col justify-center">
